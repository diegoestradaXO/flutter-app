class EsLanguage {
  Map<String, String> get language => {
    ...
    "defaultTaskDescription":"Puedes crear una nueva tarea al presionar el botón flotante con el icono (+), o puedes eliminar esta tarea presionando el bote de basur"
  };
}